...
import { Package, Tag, ShoppingBag, BarChart3, LogOut, FolderOpen } from 'lucide-react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.navigationTabs}>
          ...
          <TouchableOpacity
            style={[styles.tab, currentSection === 'analytics' && styles.activeTab]}
            onPress={() => setCurrentSection('analytics')}
          >
            <BarChart3 size={20} color={currentSection === 'analytics' ? '#FF6B35' : '#666'} />
            <Text style={[styles.tabText, currentSection === 'analytics' && styles.activeTabText]}>
              التحليلات
            </Text>
          </TouchableOpacity>
